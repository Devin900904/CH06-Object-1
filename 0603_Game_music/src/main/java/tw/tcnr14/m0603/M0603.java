...
public class M0603 extends AppCompatActivity {
    ...
    private void setupCompont() {
        complay = (ImageView) findViewById(R.id.m0603_c001);   //電腦選
        textselect = (TextView) findViewById(R.id.m0603_s001); //選擇結果
        textResult = (TextView) findViewById(R.id.m0603_f000);
...
//                            answer = getString(R.string.m0603_f000) + " " + getString(R.string.m0603_f002);
...
//                            answer = getString(R.string.m0603_f000) + " " + getString(R.string.m0603_f003);
...
//                            answer = getString(R.string.m0603_f000) + " " + getString(R.string.m0603_f001);
