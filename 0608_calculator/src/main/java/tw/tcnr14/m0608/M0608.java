...
public class M0608 extends AppCompatActivity {
    ...
    private void setupcomponent() {
        num1 = (EditText) findViewById(R.id.m0608_t001);
        num1.setText("");
    ...
    private Button.OnClickListener numberOnClick = new View.OnClickListener() {
        @Override
        public void onClick(View v) {
            String keying =num1.getText().toString();
            switch (v.getId()){
                case R.id.m0608_b000:
                    num1.setText(keying +"0");
                    break;
                case R.id.m0608_b001:
                    num1.setText(keying +"1");
                    break;
                case R.id.m0608_b002:
                    num1.setText(keying +"2");
                    break;
                case R.id.m0608_b003:
                    num1.setText(keying +"3");
                    break;
                case R.id.m0608_b004:
                    num1.setText(keying +"4");
                    break;
                case R.id.m0608_b005:
                    num1.setText(keying +"5");
                    break;
                case R.id.m0608_b006:
                    num1.setText(keying +"6");
                    break;
                case R.id.m0608_b007:
                    num1.setText(keying +"7");
                    break;
                case R.id.m0608_b008:
                    num1.setText(keying +"8");
                    break;
                case R.id.m0608_b009:
                    num1.setText(keying +"9");
                    break;
    ...
    private Button.OnClickListener calOnClick = new Button.OnClickListener() {
        @Override
        public void onClick(View v) {
            try {    nn =Double.parseDouble(num1.getText().toString());
